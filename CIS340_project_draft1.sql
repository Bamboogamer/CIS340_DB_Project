...
CREATE TABLE IF NOT EXISTS wards (
	...
	PRIMARY KEY	(ward_id),
	FOREIGN KEY (charge_nurse_id) REFERENCES staff(staff_id),
...
CREATE TABLE IF NOT EXISTS patients (
	...
	FOREIGN KEY (local_doctors) REFERENCES next_of_kin(clinic_phone_number)
);
...
CREATE TABLE IF NOT EXISTS patient_medication (
	...
	PRIMARY KEY(patient_id),
	FOREIGN KEY(patient_id) REFERENCES patients(patient_id),
	FOREIGN KEY(drug_id) REFERENCES pharmeceutical_supplies(drug_id)
);
...
CREATE TABLE IF NOT EXISTS ward_requisitions (
	...
	FOREIGN KEY (item_id) REFERENCES surgicaland_nonsurgical_supplies(item_id),
	FOREIGN KEY (charge_nurse_id) REFERENCES staff(staff_id),
	CONSTRAINT RecievedOrNot_Ck CHECK ((charge_nurse_id=null AND recieved_on_date=null) OR (charge_nurse_id!=null AND recieved_on_date!=null))
);
